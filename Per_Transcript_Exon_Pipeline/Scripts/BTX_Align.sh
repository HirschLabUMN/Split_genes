...
#PBS -l walltime=24:00:00,nodes=10:ppn=24,pmem=2500mb
#PBS -V
#PBS -N jobBTX_align
...
parallel --jobs 2 --sshloginfile unique-nodelist.txt --workdir $PWD < /panfs/roc/groups/14/hirschc1/mich0391/Projects/SplitGenes/Scripts/BTX_ReadMapCommands.txt
