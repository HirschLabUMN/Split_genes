...
parallel --jobs 1 --sshloginfile unique-nodelist.txt --workdir $PWD < /panfs/roc/groups/14/hirschc1/mich0391/Projects/SplitGenes/Scripts/Ref_to_Ref_ReadMapCommands.txt
